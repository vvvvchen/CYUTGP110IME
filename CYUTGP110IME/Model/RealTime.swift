...
//                                    value ["weight"] as! Double
    ...
    //MARK: 註冊
    func signin(account: String, password: String, name: String, gender: String, age: Int, height: Double ,weight: Double)
    {
        //隨機產生ID
        ...
        self.reference
            ...
            .setValue(["ID": id, "Account": account, "Password": password, "Name": name,"gender": gender,"age": age,"height": height,"weight": weight]) {(error, success) in
                //寫入失敗
                if let error=error
                {
